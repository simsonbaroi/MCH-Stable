// Fix: Added React to imports to resolve 'Cannot find namespace React' errors on lines 27, 64, and 158
...
import { X, ChevronDown, FileText, Printer, ChevronUp, Check, Plus } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-[7px] font-bold text-muted-foreground uppercase tracking-widest mt-0.5">{isActive ? 'Active Ledger' : 'Inactive'}</p>
            </div>
          </div>
        </div>
